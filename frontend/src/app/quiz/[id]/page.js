...
import { ArrowLeft, Clock, CheckCircle, XCircle, Brain, Star } from "lucide-react"
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          <div className="flex justify-between items-center mb-2">
            <h2 className="text-xl font-bold text-teal-800">{quiz.title}</h2>
        ...
        <Card className="bg-white border-teal-100 mb-8 shadow-sm">
          ...
          <CardFooter>
            <Button
              ...
              disabled={!isAnswered && currentQuestion < quiz.questions.length - 1}
            >
